...
namespace RetailManagment.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "employee_id,first_name,last_name,role")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "first_name,last_name,role")] Employee employee)
        {
            if (ModelState.IsValid)
            {
